...
const Header = () => {
  ...
  return (
    <header className="sticky z-40 top-0 left-0 w-full h-[67px] bg-black bg-opacity-60 backdrop-blur-sm flex p-0 gap-10 md:justify-around">
      ...
      <div id="mobile-menu" className="fixed z-40 h-screen -translate-x-[300px] left-0 top-0 flex flex-col gap-4 justify-start items-start bg-[linear-gradient(to_top_right,_#00bcd4_0%,_#0047ff_100%)] opacity-95 rounded-r-lg text-black p-8">
